...
class Adapter_TemanCerita (val context: Context, var items: List<Model_lihat_temanCerita>, val clik : (Model_lihat_temanCerita)->Unit)
    : RecyclerView.Adapter<Adapter_TemanCerita.ViewHolder>() {



    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(context).inflate(R.layout.item1_teman_cerita, parent, false))
    }
    ...
    class ViewHolder (view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindView(modelLihatTemancerita: Model_lihat_temanCerita, clik: (Model_lihat_temanCerita) -> Unit){
...
//                            bottonChat_apoteker_hidden.visibility = View.VISIBLE
                            button_chet_yuk.visibility = View.GONE
                        }else if(statusUsers.equals("tidak")){
                            if (statusApoteker == "aktif"){
//                                bottonChat_apoteker_hidden.visibility = View.VISIBLE
                                button_chet_yuk.visibility = View.GONE
                            }else if (statusApoteker == "tidak"){
